defmodule Peque.DetsQueue do
  ...
  def new(dets_name, dets_file) do
    erl_dets_file = String.to_charlist(dets_file)
    {:ok, dets} = :dets.open_file(dets_name, file: erl_dets_file)
  ...
  defp dets_load(dets) do
    {left_id, before_right_id} =
      dets
      # match pattern generated by: `:ets.fun2ms fn {id, _} when is_integer(id) -> id end`
